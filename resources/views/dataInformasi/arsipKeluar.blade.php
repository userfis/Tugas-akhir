...
@section('page-header')
    ...
    <div class="search-field d-xl-block mb-0">
        <form class="d-flex align-items-center h-100" action="{{ route('search-surat-keluar-arsip') }}" method="GET">
    ...
    <div>
        <a href="{{ route('exportExcel-sk') }}" class="btn btn-success">Export Excel</a>
    </div>
    <div class="row">
        <div class="col-md-12">
