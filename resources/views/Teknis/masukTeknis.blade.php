                                ...
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="mr-1">
                                                                        <a href="/{{ $data->id }}/teknis/edit-data"
                                                                            class="btn btn-primary btn-rounded">
                                            ...
                                            @else
                                                <a href="{{ route('tambah-teknis') }}"><button type="button"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="mr-1">
                                                                            <a href="/{{ $data->id }}/teknis/edit-data" class="btn btn-primary btn-rounded">
                                                                                <i class="mdi mdi-tooltip-edit" style="font-size: 15px;"></i>
                                                                            </a>
                                                                        </div>
                                                                        <div>
                                                                            <form action="/{{ $data->id }}/teknis/hapus" method="POST">
                                                                                @csrf
