    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="/{{ $data->id }}/teknis/admin/update-data" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="/{{ $data->id }}/teknis/update-data" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="nomor_surat">Nomor Surat</label>
                        <input type="text" name="nomor_surat" class="form-control" id="nomor_surat" placeholder=""
                    ...
                    <input type="text" name="data_id" id="data_id" value="1" hidden>
                    <button type="submit" class="btn btn-primary mr-2" fdprocessedid="cha8ou">Submit</button>
                    <a href="{{ route('masuk-teknis') }}" class="btn btn-light" fdprocessedid="p0f3cn">Cancel</a>
                </form>
            </div>
            @endcan
        </div>
