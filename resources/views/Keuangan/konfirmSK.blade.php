...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <form class="forms-sample" action="/{{ $data->id }}/staff/update-konfirm-sk" method="POST" enctype="multipart/form-data">
                @csrf
           ...
           <div class="form-group border-bottom">
            ...
            <br>
            <a href="/staff/surat-keluar" class="btn btn-primary" fdprocessedid="p0f3cn">Kembali</a>  
             @endif
