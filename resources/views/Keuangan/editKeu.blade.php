    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="/{{ $data->id }}/keuangan/admin/update-data" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="/{{ $data->id }}/keuangan/update-data" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="nomor_surat">Nomor Surat</label>
                        <input type="text" name="nomor_surat" class="form-control" id="nomor_surat" placeholder=""
